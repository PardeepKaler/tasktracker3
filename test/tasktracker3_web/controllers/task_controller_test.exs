defmodule Tasktracker3Web.TaskControllerTest do
  ...
  @create_attrs %{completed: true, description: "some description", timeSpent: "120.5", title: "some title"}
  @update_attrs %{completed: false, description: "some updated description", timeSpent: "456.7", title: "some updated title"}
